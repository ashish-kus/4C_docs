...
`sys.build_prlist()` builds a list of ALL currently running programs into a file using the sys.t_prlist file definition.
...
```text
The follwing example is from the 4C debugger program sys.dbg.trace.
