---
title: "sys.set_debug()"
description: "turns the 4C Debugger on or off"
weight: 277
draft: false
---
...
`sys.set_debug()` can be called from anywhere. It is used in the bootstrap program development programs and is toggled on/off with the user12 function key.
