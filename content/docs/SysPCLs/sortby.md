---
title: "sys.sort_by()"
description: "allows you to specify the order tha"
weight: 321
draft: false
---
...
```text
The following
code is from the drinit() PCL in the an.call.de.sel program in
...
[`sys.dr_init()`]({{< ref "drinit.md" >}}) [`sys.dr_include()`]({{< ref "drinclude.md" >}})
