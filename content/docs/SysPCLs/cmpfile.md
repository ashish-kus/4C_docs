---
title: "sys.cmp_file()"
description: "compares all fields in the field buffers of tw"
weight: 42
draft: false
---
...
`sys.cmp_file()` compares all fields in the field buffers of two different asfiles.
...
`sys.cmp_file()` compares each field in two different asfiles until all fields of one file have compared ok or until there is a compare fail. `sys.cmp_file()` compares even the primary key fields.
