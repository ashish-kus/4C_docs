...
description: "lets the application change th"
weight: 312
draft: false
---
...
- `integer` — `<wlflags>` -
wlflags can be any combination of
WL_TABC, WL_MENU, and WL_OVERRIDE.
- `alpha` — `<label>` -
The new value for either the Window menu label or
