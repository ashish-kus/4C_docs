...
FCJSon::`ArrayAddDouble()` adds a simple double value to the end of an array

## Usage

```text
rc = FCJSon::ArrayAddDouble(<jsonident>,<fval or dpyval> [, <dpyval>]);
```
...
FCJSon::`ArrayAddDouble()` can be called anytime you have a valid ident to a json array.
