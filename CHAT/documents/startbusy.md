...
description: "starts a progress bar on the client"
weight: 326
draft: false
---
...
- `<name>` — an alpha that can be used to reference this progress
...
- `<flags>` — and integer argument that consists of any of the
